...
public class RegistracijaKompanijeNeuspeh1 {
  @Test
  public void registracijaKompanijeNeuspesnaPoljeNazivPrazno() {
	  System.setProperty("webdriver.edge.driver", "C:\\Users\\TS\\Desktop\\msedgedriver.exe");
		...
		driver.findElement(By.name("specijalnost")).sendKeys("Android app dev");
		...
		try {
			Assert.assertTrue(errTxt.contains("Polje naziv kompanije ne sme biti prazno!"));
			System.out.println("registracija neuspesna zbog praznog polja naziv kompanije Pass");
		} catch (Exception e) {
			System.out.println("registracija neuspesna zbog praznog polja naziv kompanije Fail");
		}
		driver.quit();
  }
}
